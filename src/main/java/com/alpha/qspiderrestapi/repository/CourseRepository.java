...
public interface CourseRepository extends JpaRepository<Course, Long> {
	...
	@Transactional
	@Modifying
	@Query(value = "delete from course_subject where subject_id IN (:subjectIds) and course_id = :courseId", nativeQuery = true)
	void removeSubjectsFromCourse(@Param("subjectIds") List<Long> subjectIds, @Param("courseId") Long courseId);
